...
#________________________ASSIGNMENT QUESTIONS________________________

#______________________Q1_________________________________
...
#____________Q2_________________________________

@app.get("/products/price/{product_id}")
...
#______________________Q3_________________________________

@app.post("/feedback")
def submit_feedback(data: CustomerFeedback):
    feedback.append(data.dict())  # Save the feedback
    return {
...
#______________________Q4_________________________________
...
#______________________Q5_________________________________
